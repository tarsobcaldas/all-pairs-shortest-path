...
\begin{tikzpicture}
    ...
    \addplot[red, every node near coord/.append style = {yshift = -.5cm},
        visualization depends on ={\thisrow{runsMean900} \as \labela} 
      ] table [meta=Configuration, y expr=\thisrow{runsMean900}, x expr=\coordindex] \loadedtable; 

    \addplot[blue,
    visualization depends on ={\thisrow{{totalMean900}} \as \labela} 
      ] table [meta=Configuration, y expr=\thisrow{totalMean900}, x expr=\coordindex] \loadedtable;
	\end{axis}
\end{tikzpicture}
