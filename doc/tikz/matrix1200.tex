...
\begin{tikzpicture}
    ...
    \addplot[red,
        visualization depends on ={\thisrow{runsMean1200} \as \labela} 
      ] table [meta=Configuration, y expr=\thisrow{runsMean1200}, x expr=\coordindex] \loadedtable; 

    \addplot[blue,
    visualization depends on ={\thisrow{{totalMean1200}} \as \labela} 
      ] table [meta=Configuration, y expr=\thisrow{totalMean1200}, x expr=\coordindex] \loadedtable;
	\end{axis}
\end{tikzpicture}
