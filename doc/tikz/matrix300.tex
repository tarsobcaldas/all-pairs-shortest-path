...
\begin{tikzpicture}
    ...
    \addplot[red,
        visualization depends on ={\thisrow{runsMean300} \as \labela} 
      ] table [meta=Configuration, y expr=\thisrow{runsMean300}, x expr=\coordindex] \loadedtable; 

    \addplot[blue,
    visualization depends on ={\thisrow{{totalMean300}} \as \labela} 
      ] table [meta=Configuration, y expr=\thisrow{totalMean300}, x expr=\coordindex] \loadedtable;
	\end{axis}
\end{tikzpicture}
