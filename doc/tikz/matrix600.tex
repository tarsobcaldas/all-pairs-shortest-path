...
\begin{tikzpicture}
	\begin{axis}
		...
		\addplot[blue,
			visualization depends on ={\thisrow{{totalMean600}} \as \labela}
		] table [meta=Configuration, y expr=\thisrow{totalMean600}, x expr=\coordindex] \loadedtable;

    \addplot[red, every node near coord/.append style = {yshift = -.5cm},
		visualization depends on ={\thisrow{runsMean600} \as \labela}
		] table [meta=Configuration, y expr=\thisrow{runsMean600}, x expr=\coordindex] \loadedtable;
